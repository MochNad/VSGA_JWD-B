...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($emailPrefix)) {
        ...
        $sql = "INSERT INTO users (firstname, lastname, email, password, address, birthplace, birthdate)
                VALUES ('$firstname', '$lastname', '$email', '$password', '$address', '$birthplace', '$birthdate')";
